<template id="">
    <span>
        <div class="card">
            ...
            <form action="" method="post" @submit.prevent="serviceHeadingEntry()">
                    ...
                    <div class="supplier-entry py-4 px-2 comm-form-back-img">
                        <div
                            ...
                            <div class="form-group">
                                <label> Name <i class="fa fa-star text-danger text-10 cursor-pointer"
                                        title="Mendatory Field" data-placement="top" data-toggle="tooltip"
                                        data-original-title="Mendatory Field"></i>
                                </label>
        ...
        <div class="supplier-entry py-1 px-1">
            <div class="card-body table-responsive bg-white">
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(singleList, index) in serviceHeadingLists" :key="index">
                            <td>{{ index + 1 }}</td>
...
export default {
    ...
    methods: {
        ...
        serviceHeadingEntry() {
            ...
            this.form.post("serviceHeading").then((response) => {
        ...
        serviceHeadingShow() {
            ...
            this.form.get("/serviceHeading").then((res) => {
                this.serviceHeadingLists = res.data.data;
            });

        },

        serviceHeadingDelete($id) {
            axios.delete("/serviceHeading/" + $id).then((res) => {
                Toast.fire({
                    icon: "success",
