<template id="">
    <span>
        <div class="card">
            ...
            <form action="" method="post" @submit.prevent="addressDetailsEntry()">
        ...
        <div class="supplier-entry py-1 px-1">
            <div class="card-body table-responsive bg-white">
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(singleList, index) in addressDetailsLists " :key="index">
                            <td>{{ index + 1 }}</td>
...
export default {
    ...
    methods: {
        ...
        addressDetailsEntry() {
            ...
            this.form.post("addressDetails").then((response) => {
        ...
        addressDetailsShow() {
            ...
            this.form.get("/addressDetails").then((res) => {
                this.addressDetailsLists = res.data.data;
            });

        },

        addressDetailsDelete($id) {
            axios.delete("/addressDetails/" + $id).then((res) => {
                Toast.fire({
                    icon: "success",
