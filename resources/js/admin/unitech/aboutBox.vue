<template id="">
    <span>
        <div class="card">
            ...
            <form action="" method="post" @submit.prevent="aboutBoxEntry()">
        ...
        <div class="supplier-entry py-1 px-1">
            <div class="card-body table-responsive bg-white">
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(singleList, index) in aboutBoxLists " :key="index">
                            <td>{{ index + 1 }}</td>
...
export default {
    ...
    methods: {
        ...
        aboutBoxEntry() {
            ...
            this.form.post("aboutBox").then((response) => {
        ...
        aboutBoxShow() {
            ...
            this.form.get("/aboutBox").then((res) => {
                this.aboutBoxLists = res.data.data;
            });

        },

        aboutBoxDelete($id) {
            axios.delete("/aboutBox/" + $id).then((res) => {
                Toast.fire({
                    icon: "success",
