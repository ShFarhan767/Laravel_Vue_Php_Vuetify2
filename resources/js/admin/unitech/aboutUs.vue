<template id="">
    <span>
        <div class="card">
            ...
            <form action="" method="post" @submit.prevent="aboutUsEntry()">
        ...
        <div class="supplier-entry py-1 px-1">
            <div class="card-body table-responsive bg-white">
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(singleList, index) in aboutUsLists " :key="index">
                            <td>{{ index + 1 }}</td>
...
export default {
    ...
    methods: {
        ...
        aboutUsEntry() {
            ...
            this.form.post("aboutUs").then((response) => {
        ...
        aboutUsShow() {
            ...
            this.form.get("/aboutUs").then((res) => {
                this.aboutUsLists = res.data.data;
            });

        },

        aboutUsDelete($id) {
            axios.delete("/aboutUs/" + $id).then((res) => {
                Toast.fire({
                    icon: "success",
