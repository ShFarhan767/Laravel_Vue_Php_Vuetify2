<template id="">
    <span>
        <div class="card">
            ...
            <form action="" method="post" @submit.prevent="galleryCardEntry()">
        ...
        <div class="supplier-entry py-1 px-1">
            <div class="card-body table-responsive bg-white">
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(singleList, index) in galleryCardLists" :key="index">
                            <td>{{ index + 1 }}</td>
...
export default {
    ...
    methods: {
        ...
        galleryCardEntry() {
            ...
            this.form.post("galleryCard").then((response) => {
        ...
        galleryCardShow() {
            ...
            this.form.get("/galleryCard").then((res) => {
                this.galleryCardLists = res.data.data;
            });

        },

        galleryCardDelete($id) {
            axios.delete("/galleryCard/" + $id).then((res) => {
                Toast.fire({
                    icon: "success",
