       ...
       <div class="card main-card  element-block-example">
           <div class="card-header">
              ...
              <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/sightseeing@activity@new" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > + Add New </router-link>
              </div>
            </div>
              ...
              <tr class="alert-info">
                 ...
                 <tbody>
                  <tr>
                    <td> 1 </td>
                    <td> Free Ticket </td>
                    <td> Free Ticket Free Ticket Free Ticket Free Ticket </td>
