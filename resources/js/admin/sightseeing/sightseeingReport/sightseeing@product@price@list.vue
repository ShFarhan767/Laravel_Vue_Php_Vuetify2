...
export default {
  ...
  methods: {
    ...
    assetBrandList() {
      ...
      var contact =
        this.gets.mobileNo + ", " + this.gets.email + ", " + this.gets.website;
      ...
      $(document).ready(function () {
        ...
        var table = $("#sampleTable").DataTable({
          ...
          language: {
            processing:
              "<div style='color:white;position:fixed;top:35%;left:8%;width:90%;min-height:150px;max-height:80%;background:url(/dashboard/assets/images/pre-loader.gif),rgba(0,0,0,.2);background-repeat:no-repeat;background-position:center top;z-index:10;'>Processing..</div>",
          },
          serverSide: true,
          columnDefs: [
          ...
          buttons: [
            ...
            },
            {
              ...
              messageTop:
                ...
                companyName +
                '</h3><h5 class="text-center">' +
                address +
                '</h5><h5 class="text-center border-bottom">' +
                contact +
                '</h5><center><span class="badge badge-light border border border-secondary">' +
                pageTitle +
                "</span></center>",
              exportOptions: {
                columns: [0, 1],
