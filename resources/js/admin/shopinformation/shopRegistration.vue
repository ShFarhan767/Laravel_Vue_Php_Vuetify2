...
<!-- 
  ...
  <input class="form-check-input" type="radio" @change.prevent="shop()" v-model="this.form.refferType" value="1" name="inlineRadioOptions" id="inlineRadio1" >
  <label class="form-check-label" for="inlineRadio1">Shop</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" @change.prevent="employee()"  v-model="this.form.refferType" value="2" name="inlineRadioOptions"  id="inlineRadio2">
