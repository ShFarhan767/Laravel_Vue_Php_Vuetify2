       ...
       <div class="card main-card  element-block-example">
           <div class="card-header">
              ...
              <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/new@visa@price" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > + Add New </router-link>
              </div>
            </div>
              ...
              <tr class="alert-info">
                 ...
                 <tbody>
                  <tr>
                    ...
                    <td> Thailand </td>
                    <td> Online Visa </td>
                    <td> From-3 jan 2022 to- 5 jan 2022 </td>
                    <td> 100 </td>
                    <td> 200 </td>
                    <td> 300 </td>
                    <td> <span class="badge badge-primary"> Timeline </span> </td>
                    
                    <td> <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Price Update</button> </td>
                  </tr>
                 </tbody>
                 <!-- <tbody> <tr> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Price Update</h5>
        ...
        <div class="form-group">
              ...
              <div class="form-group">
                <label> From
                    ...
                    <input type="date" class="form-control" value="2022-03-12">
                        
              </div>
              <div class="form-group">
                <label> To </label>
                    <input type="date" class="form-control" value="2022-03-16">  
              </div>
              <div class="form-group">
