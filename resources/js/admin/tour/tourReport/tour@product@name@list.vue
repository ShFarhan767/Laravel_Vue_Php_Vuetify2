              ...
              <tr class="alert-info">
                 ...
                 <tbody>
                  <tr>
                    ...
                    <td> 
                      <span class="badge badge-primary"  data-toggle="modal" data-target="#exampleModal"> View Facility </span>
                    </td>
                    <td> coral iceland </td>
                    <td> thailand, pataiya, coral iceland </td> 
                    <td> 
                        <ul>
                            <li>main city 2 km</li>
                            <li>sea beach 1 km </li>
                        </ul> </td>
                    <td> 
