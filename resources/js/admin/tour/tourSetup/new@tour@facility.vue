    ...
    <span>
      <div class="card">
        <div class="card-header">
          <h3>
            <i class="header-icon lnr-pencil icon-gradient bg-happy-itmeo"></i> Tour Facility Entry
          </h3>

          <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/tour@facility@entry" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > < Back </router-link>
          </div>
        </div>
