      ...
      <div class="card">
        ...
        <div class="supplier-entry p-0 pt-3 comm-form-back-img">
          <form @submit.prevent="hotelLocationCreate()">
            ...
            <div class="form-group">
              <label> Package  <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
               </label>
                    <select class="form-control">
                 ...
                 <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <td> <input type="date" class="form-control"> </td>
                                <td><span class="input-group-text" id="">5 Days</span> </td>
                            </tr>
                        </table> 
                      </div>
