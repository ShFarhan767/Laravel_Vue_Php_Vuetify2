    ...
    <span>
      <div class="card">
        <div class="card-header">
          <h3>
            <i class="header-icon lnr-pencil icon-gradient bg-happy-itmeo"></i> Cheque Entry
          </h3>
          <div class="btn-actions-pane-right text-capitalize">
          <router-link to="/cheque@entry" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > < Back </router-link>
                </div>
        </div>
            ...
            <div class="form-group">
              <label> Account 
                <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
                    ...
                    <option value=""> Doofaz IT LImited (233.443.334.33)   </option>
                    </select>  
            </div>
