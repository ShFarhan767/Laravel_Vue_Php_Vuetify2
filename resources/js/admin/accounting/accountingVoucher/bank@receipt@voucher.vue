      ...
      <div class="card main-card element-block-example">
        <div class="card-header">
          ...
          <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/bank@receipt@voucher@new" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
          ...
          <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <span class="badge badge-primary"  data-toggle="modal" data-target="#exampleModal">BR-23/22</span> </td>
                <td> Bank Receipt 
                    </br>
