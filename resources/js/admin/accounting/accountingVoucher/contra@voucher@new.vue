      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/contra@voucher" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > < Back </router-link>
            </div>
        </div>
          ...
          <form @submit.prevent="hotelLocationCreate()">
           ...
           <div class="row">
              ...
              <label> From  <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
                    ...
                    <select class="form-control" v-model="form.typeFrom" @change="bankInfoFrom()">
                    <option value=""> Select From  </option>
                    <option value="1">  General Cash  </option> 
                    <option value="2"> Islami Bank  </option> 
                    </select>  
            </div>
            
                
               <div class="" v-if="bankInfoFromStatus">
                <div class="form-group">
            ...
            <div class="form-group">
              <label> Account Name <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
                </label>
                    <select class="form-control">
              ...
              <label> From  <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
                    ...
                    <select class="form-control" v-model="form.typeTo" @change="bankInfoTo()">
                    <option value=""> Select From  </option>
                    <option value="1">  General Cash  </option> 
                    <option value="2"> Islami Bank  </option> 
                    </select>  
               ...
               <div class="" v-if="bankInfoToStatus">
                <div class="form-group">
              <label> Bank Name  <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mandatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mandatory Field"></i>
                </label>
                    <select class="form-control">
