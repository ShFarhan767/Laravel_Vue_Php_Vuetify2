<template>
    <span>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <router-link to="/hotel@booking@List" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"> Booking List </router-link>
      ...
      <div class="card">
        <form @submit.prevent="salesInvoiceEntry()">
        ...
        <div class="card-body">
          ...
          <div class="product-page pl-2">
              ...
              <div class="form-row">
                ...
                <div class="form-group mb-0 col-lg-2 col-md-4 col-sm-4 col-6 d-none">
          ...
          <div class="product-detail pb-4 mt-4">
            <div class="row m-0">
              <div class="col-lg-8"></div>
              <div class="col-lg-4 col-12 p-0 pl-2 float-right">
                  ...
                  <div class="col-md-12">
                    <div class="form-group m-0 row mt-2">
                      ...
                      />
                      <div class="col-lg-5 col-md-6 col-sm-4 col-12 pl-0">
                        <p>Sub Total</p>
                      </div>
                    ...
                    <div class="form-group m-0 row mt-2">
                      <div class="col-lg-5 col-md-6 col-sm-4 col-12 pl-0 d-none">
                        <p>{{preDueText}}</p>
                      </div>
                      <div class="col-lg-7 col-md-6 col-sm-8 col-12 pl-0  d-none">
                    ...
                    <div class="form-group m-0 row mt-2 d-none">
                      <div class="col-lg-5 col-md-6 col-sm-4 col-12 pl-0">
                        <p>Due.Limit</p>
                      </div>
                      <div class="col-lg-7 col-md-6 col-sm-8 col-12 pl-0">
              ...
              <div class="col-lg-8 col-md-8 col-12 px-3 float-right"></div>
              <div class="col-lg-4 col-md-4 col-12 px-3 float-right">
                ...
                <div class="modal-body pt-0"  v-if="guestInfo == true">
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6 col-xs-12 p-0">
                            ...
                            <div v-if="morepay">
                              <div class="row border-bottom text-center d-none">
                              ...
                              <div v-if="fromshow" class=" d-none">
  ...
  searchProductBarcode(){
    // alert(this.form.productBarcode);
      ...
      calculateSaleDiscount(){
        ...
        this.form.totalPrice = (this.form.price*this.form.noOfRoom)*this.form.night;
        this.form.totalBalance = (this.form.price*this.form.noOfRoom)*this.form.night;
        this.form.totalPayable = (this.form.price*this.form.noOfRoom)*this.form.night;

      },
      calculateExtraBed(){
                this.form.totalPrice = ((this.form.price*this.form.noOfRoom)*this.form.night)+(this.form.extraBed*this.form.extra_bed_charge);
                this.form.totalBalance = ((this.form.price*this.form.noOfRoom)*this.form.night)+(this.form.extraBed*this.form.extra_bed_charge);
                this.form.totalPayable = ((this.form.price*this.form.noOfRoom)*this.form.night)+(this.form.extraBed*this.form.extra_bed_charge);
      },
    ...
    this.loading = false;
      ...
      salesInvoiceEntry() {
        ...
        if (1) {
          ...
          this.form.post("/hotelInvoiceEntry")
            .then((res) => {
             this.loading = false;
              Toast.fire({
                icon: "success",
