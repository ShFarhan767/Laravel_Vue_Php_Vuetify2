<template id="">
        ...
        <div class="card-header">
          <h3>
            ...
            <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/hotel@cancellation@policy" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > < Back </router-link>
            </div>

        </div>
        <div class="supplier-entry p-0 pt-3 comm-form-back-img">
          <form @submit.prevent="htl_cancelation_policy()">
            <div
              class="
                col-lg-7
                px-lg-5
            ...
            >
              ...
              <div class="form-group">
                ...
                <input type="text"
                v-model="form.cancel_policy_name"
                  class="form-control"
                placeholder="Cancellation Policy"
                :class="{ 'is-invalid': form.errors.has('cancel_policy_name') }">
                <has-error :form="form" field="cancel_policy_name"></has-error>
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      htl_cancelation_policy() {
        this.loading = true;
        this.form
          .post("/htl_cancelation_policy")
          .then((res) => {
            this.loading = false;
