    ...
    <span>
      <div class="card">
        <div class="card-header">
          <h3>
            <i class="header-icon lnr-pencil icon-gradient bg-happy-itmeo"></i> New Room 
          </h3>
        ...
        <div class="supplier-entry p-0 pt-3 comm-form-back-img">
          <form @submit.prevent="htlRomInformationEntry()">
            <div
              class="col-lg-10 px-lg-5 col-sm-10 offset-sm-1 col-12 pb-2 pt-2 mb-3 supplier-border comm-form-box-back-color
              ">
            ...
            <div class="row">
             ...
             <option v-for="hotelList in hotelLists" :value="hotelList.id"> {{ hotelList.hotel_name }}    </option>
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="form.room_title" class="form-control">
                        <has-error :form="form" field="room_title"></has-error> 
                    </div>
                    ...
                    <div class="form-group">
                      <hr>
                      <h4 class="text-center"><u> Room Pricing </u> </h4>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                    <label> price type <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i></label>
                  ...
                  <td>
                    ...
                    <input  type="text" v-model="form.vendor_price" class="form-control" placeholder="Vendor price" :class="{ 'is-invalid': form.errors.has('vendor_price') }">
                  ...
                  <td>
                    ...
                    <input  type="text" v-model="form.customer_price" class="form-control" placeholder="B2C Price" :class="{ 'is-invalid': form.errors.has('customer_price') }">
                  ...
                  <td>
                    ...
                    <input  type="text" v-model="form.agent_price" class="form-control" placeholder="B2B price" :class="{ 'is-invalid': form.errors.has('agent_price') }">
                    <has-error :form="form" field="agent_price"></has-error>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                    <label> Showing price <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i></label>
                    <input  type="text" v-model="form.showing_price" class="form-control" placeholder="Showing price" :class="{ 'is-invalid': form.errors.has('showing_price') }">
                    <has-error :form="form" field="showing_price"></has-error>
                    </div>
                  </td>
                  ...
                  <td colspan="4">
                        ...
                        <div class="input-group">
                            <table class="table table-bordered">
                              ...
                              <tr v-for="htlRomPricingList,index in htlRomPricingLists">
                                ...
                                <td> {{ htlRomPricingList.showing_price }} </td>
                    ...
                    <div class="form-group">
                      <label> Room Quantity </label>
                        <div class="row">
                        <div class="col-6">
                          <input  type="text" v-model="form.quantity" class="form-control" placeholder="Enter Room Quantity" :class="{ 'is-invalid': form.errors.has('quantity') }">
                    ...
                    <div class="form-group">
                      <label> Maximum Stay  </label>
                        <div class="row">
                        <div class="col-6">
                          <input  type="text" v-model="form.minimum_stay" class="form-control" placeholder="Night(s)" :class="{ 'is-invalid': form.errors.has('minimum_stay') }">
                ...
                <label> Child Age </label>
                        <div class="row">
                        <div class="col-6">
                          <select v-model="form.child_age" class="form-control" :class="{ 'is-invalid': form.errors.has('child_age') }">
                            <option value=""> Select Child Age </option>
                            <option v-for="n in 18" :value="n">
                             <span v-if="n>1"> {{ n }} </span>
                            </option>
                          </select>
                          <has-error :form="form" field="child_age"></has-error>
                        </div>  
...
<!-- ------- // translate information model  -->
  ...
  export default {
    ...
    methods: {
      ...
      htlRomInformationEntry(){

        this.form.facilities = this.selected;
    
    this.form.post("htl_rom_information").then((response) => {
