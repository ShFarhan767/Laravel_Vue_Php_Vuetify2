        ...
        <div class="card-header">
          <h3>
            ...
            <div class="btn-actions-pane-right text-capitalize">
                  <router-link to="/room@type@entry" class="btn-wide btn-outline-2x mr-md-2 btn btn-primary btn-sm"
                   > < Back </router-link>
            </div>
        </div>
        <div class="supplier-entry p-0 pt-3 comm-form-back-img">
          <form @submit.prevent="roomTypeEntry()">
            <div
              class="
                col-lg-7
                px-lg-5
            ...
            >
              ...
              <div class="form-group">
                ...
                :class="{ 'is-invalid': form.errors.has('room_type_name') }">
                <has-error :form="form" field="room_type_name"></has-error>  
              </div>
