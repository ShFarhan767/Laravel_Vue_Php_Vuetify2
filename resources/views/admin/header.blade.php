<div class="app-header header-shadow">
    ...
    <div class="app-header__menu">
        <span>
            <button type="button" id="profile1" class="btn-icon btn-icon-only btn btn-primary btn-sm mobile-toggle-header-nav">
        ...
        <div class="container d-none d-md-block">
          <div class="col-md-10">
              <div class="input-holder">
                   <!-- <span style="float:left;padding:1px;padding-left:5px;margin-top:16px;border:1px solid red;border-right:none;border-radius:10px 0 0 10px;">Welcome to</span>
                   <h1 class="comName" style="float:left;line-height:50px;text-transform: capitalize;margin-left:10px; ">{{ Auth::user()->shopName }}</h1> -->
              </div>
