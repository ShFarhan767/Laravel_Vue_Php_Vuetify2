...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getHotelInfo: function getHotelInfo() {
      ...
      this.selected = [];
      var uri = "room_id_by_hotel_info/" + this.form.room_id;
      axios.get(uri).then(function (response) {
        _this.form.fill(response.data.data);

        _this.hotelTranslateInfos = response.data.htl_translate_list;
        _this.roomImageLists = response.data.hotel_room_image;
        _this.form.hotel_code = response.data.hotel.hotel_code;
        _this.form.hotel_name = response.data.hotel.hotel_name;
        _this.form.hotel_id = response.data.hotel.id;
    ...
    imageTitleList: function imageTitleList() {
      ...
      axios.get(uri).then(function (response) {
        _this2.imageTypeLists = response.data.data;
      });
    },
    ...
    htlRomInformationUpdate: function htlRomInformationUpdate() {
      var _this3 = this;

      this.form.facilities = this.selected;
      this.form.put("htl_rom_information/" + this.$route.params.id).then(function (response) {
        if (response.data.changePurchaseType) {
          ...
          _this3.$router.push('/hotel@room@setup');
        }
      })["catch"](function (res) {
    ...
    htlRomInformationShow: function htlRomInformationShow() {
      ...
      this.form.get("/htl_rom_information").then(function (res) {
        _this4.htlRomInformationLists = res.data.data;
      });
    },
    htlRomPricingEntry: function htlRomPricingEntry() {
      ...
      this.form.post("htl_rom_pricing").then(function (response) {
        if (response.data.changePurchaseType) {
          _this5.exit = true;
          _this5.mess = response.data.changePurchaseType; // Toast.fire({
          //     icon: 'error',
          //     title: 'Change Your Admin Type Name'
          // })
        } else {
          ...
          }), _this5.form.day_price_type_id = '';
          _this5.form.agent_price = '';
          _this5.form.vendor_price = '';
          _this5.form.customer_price = '';

          _this5.htlRomPricingShow();
        }
      })["catch"](function (res) {
    ...
    htlRomPricingShow: function htlRomPricingShow() {
      ...
      this.form.get("/htl_rom_pricing_list/" + this.form.hotel_id + '/' + this.form.room_type_id + '/' + this.form.bed_type_id).then(function (res) {
        _this6.htlRomPricingLists = res.data.data;
      });
    },
    ...
    hotelTranslateUpdate: function hotelTranslateUpdate() {
      ...
      this.form.post("/htl_translate_update/" + this.form.hotel_id).then(function (res) {
        ...
        if (res.data.changeAssetBrandName) {
          ...
          _this8.form.language_id = '';
          _this8.form.trans_hotel_name = '';
          _this8.form.trans_hotel_description = '';
          _this8.form.trans_meta_title = '';
          _this8.form.trans_meta_keyword = '';
          _this8.form.trans_meta_description = '';
        }

        _this8.getHotelTranslateList();
    ...
    getHotelTranslateList: function getHotelTranslateList() {
      ...
      axios.get(uri).then(function (response) {
        _this9.hotelTranslateInfos = response.data.data;
      });
    },
    changeImage: function changeImage(event) {
      ...
      reader.onload = function (event) {
        _this10.form.logo = event.target.result;
    ...
    hotelFacilityList: function hotelFacilityList() {
      ...
      axios.get(uri).then(function (response) {
        _this11.users = response.data.data;
      });
    },
    hotelList: function hotelList() {
      ...
      var uri = "hotel_list";
      axios.get(uri).then(function (response) {
        _this12.hotelLists = response.data.data;
      });
    },
    propertyTypeList: function propertyTypeList() {
      ...
      axios.get(uri).then(function (response) {
        _this13.propertyTypeLists = response.data.data;
      });
    },
    roomTypeList: function roomTypeList() {
      ...
      axios.get(uri).then(function (response) {
        _this14.roomTypeLists = response.data.data;
      });
    },
    bedTypeList: function bedTypeList() {
      ...
      axios.get(uri).then(function (response) {
        _this15.bedTypeLists = response.data.data;
      });
    },
    cancelationPolicyList: function cancelationPolicyList() {
      ...
      axios.get(uri).then(function (response) {
        _this16.cancelationPolicyLists = response.data.data;
      });
    },
    roomPriceTypeList: function roomPriceTypeList() {
      ...
      axios.get(uri).then(function (response) {
        _this17.dayPriceTypeLists = response.data.data;
      });
    },
    // getHotelInfo() {
    //   this.selected = [];
    ...
    hotelRoomTranslateInfoDelete: function hotelRoomTranslateInfoDelete(id) {
      var _this21 = this;

      axios.get("hotelRoomTranslateInfoDelete/" + id).then(function (res) {
        Toast.fire({
          icon: "success",
          title: "Delete Successfully"
        });

        _this21.getHotelTranslateList();
      });
    },
    hotelRoomImageInfoDelete: function hotelRoomImageInfoDelete(id) {
      var _this22 = this;

      axios.get("hotelRoomImageInfoDelete/" + id).then(function (res) {
        Toast.fire({
          icon: "success",
          title: "Delete Successfully"
        });

        _this22.getRoomImageList();
      });
    }
  }
});
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=template&id=94a74908&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=template&id=94a74908& ***!
  \*****************************************************************************************************************************************************************************************************************************/
          ...
          "form",
          {
            on: {
              submit: function($event) {
                ...
                return _vm.htlRomInformationUpdate()
              }
            }
          },
          [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.form.cancellation_policy_id,
                                    expression: "form.cancellation_policy_id"
                                  }
                                ],
                                staticClass: "form-control",
                                class: {
                              ...
                              [
                                _c("option", { attrs: { value: "" } }, [
                                  _vm._v(" Select Cancellation Policy ")
                                ]),
                                _vm._v(" "),
                                _vm._l(_vm.cancelationPolicyLists, function(
                                  ...
                                  return _c(
                                    ...
                                    {
                                      domProps: {
                                        value: cancelationPolicyList.id
                                      }
                                    },
                                    [
                                      _vm._v(
                                        " " +
                                          _vm._s(
                                            cancelationPolicyList.cancel_policy_name
                                          ) +
                                          "    "
                                      )
                                    ]
                                    ...
                                    [
                                      ...
                                      _c(
                                        "select",
                                        {
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.form.day_price_type_id,
                                              expression:
                                          ...
                                          attrs: {
                                            placeholder: "Enter Day price type"
                                          },
                                          on: {
                                            change: [
                                              function($event) {
                                        ...
                                        directives: [
                                          {
                                            ...
                                            expression: "form.customer_price"
                                          }
                                        ],
                                        staticClass: "form-control",
                                        class: {
                                        ...
                                        _c(
                                          "button",
                                          {
                                            ...
                                            on: {
                                              click: function($event) {
                                                $event.preventDefault()
                                                return _vm.hotelRoomImageInfoDelete(
                                                  roomImageList.id
                                                )
                                              }
                                            }
                                        ...
                                        _c(
                                          "button",
                                          {
                                            ...
                                            on: {
                                              click: function($event) {
                                                $event.preventDefault()
                                                return _vm.hotelRoomTranslateInfoDelete(
...
/***/ "./resources/js/admin/hotel/roomSetup/update@new@room.vue":
/*!****************************************************************!*\
  !*** ./resources/js/admin/hotel/roomSetup/update@new@room.vue ***!
  \****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _update_new_room_vue_vue_type_template_id_94a74908___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./update@new@room.vue?vue&type=template&id=94a74908& */ "./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=template&id=94a74908&");
/* harmony import */ var _update_new_room_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update@new@room.vue?vue&type=script&lang=js& */ "./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _update_new_room_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _update_new_room_vue_vue_type_template_id_94a74908___WEBPACK_IMPORTED_MODULE_0__["render"],
  _update_new_room_vue_vue_type_template_id_94a74908___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/admin/hotel/roomSetup/update@new@room.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_update_new_room_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../node_modules/vue-loader/lib??vue-loader-options!./update@new@room.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_update_new_room_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=template&id=94a74908&":
/*!***********************************************************************************************!*\
  !*** ./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=template&id=94a74908& ***!
  \***********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_update_new_room_vue_vue_type_template_id_94a74908___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./update@new@room.vue?vue&type=template&id=94a74908& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/hotel/roomSetup/update@new@room.vue?vue&type=template&id=94a74908&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_update_new_room_vue_vue_type_template_id_94a74908___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_update_new_room_vue_vue_type_template_id_94a74908___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
